...
\begin{minipage}{0.75\linewidth}
    \centering
%Entry1
    {\uppercase{\huge A Game Theoretic Approach to Deadline Adherence in
the Face of Incomplete Information\par}}
    \vspace{2cm}
%Author's name
...
\hypertarget{game}{%
\section{\texorpdfstring{Game \label{}}{Game }}\label{game}}
